class FederationCcEntry < ActiveRecord::Base
  ...
  validates :quant, presence: true, numericality: { greater_than: 0, less_than_or_equal_to: 100 }, unless: -> { state == "X" }
  validates :quant, presence: true, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 100 }, if: -> { state == "X" }
